                  ...
                  >
                    <div className="header flex items-center justify-between">
                      <div className="author flex items-center">
                        ...
                        <span className="name text-[1.2rem] text-[#292929] font-semibold ml-2">Anh Chao Em</span>
                      </div>
                    </div>
                    <div className="body flex sm:flex-row items-center">
                      <div className="info text-2xl flex-1 pr-8">
                        ...
                        <div className="date mt-4">
                          ...
                          <span className="updatedate ">{date}</span>
                        </div>
                      </div>
